...
%% 26 Aug 2026 (SELF_PUBLISH_PLAN_20260826.md): no journal, no submission.
%% This extended tier is the complete record; the short version accompanies it.
%%
...
supporting exhibits; a short version accompanies it in the same record.}}

\markboth{From Lagging to Leading --- extended version}%
...
balanced panel, if anything, understates the national drift. Five national totals follow, each on the sample its method requires, and Table~\ref{tab:panels} sets them side by side. They differ by sample, window and summary statistic rather than by measurement; a reader wanting one figure for New Zealand should take the first row.
...
connections served---on the New Zealand panel, about 230~VAr per connection
...
doing: at about 230~VAr per connection added over 2013--2025, with no detectable
